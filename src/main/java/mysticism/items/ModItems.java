...
public class ModItems {
    ...
    public static final Item THUNDERORB = registerItem("thunder_orb", ThunderItem::new, new Item.Settings().useCooldown(15));    public static final Item CREEPERTOTEM = registerItem("creeper_totem", CreeperTotemItem::new, new Item.Settings());
